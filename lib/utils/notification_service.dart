    ...
    FirebaseMessaging.onMessageOpenedApp.listen((RemoteMessage message) async {
      ...
      if (message.notification != null) {
        ...
        if (message.data['type'] == "chat") {
          await FireStoreUtils.getUserProfile(message.data['senderId'] == FireStoreUtils.getCurrentUid() ? message.data['receiverId'] : message.data['senderId'])
              .then((value) async {
            await FireStoreUtils.getOwnerProfile(value?.ownerId ?? '').then((value) async {
